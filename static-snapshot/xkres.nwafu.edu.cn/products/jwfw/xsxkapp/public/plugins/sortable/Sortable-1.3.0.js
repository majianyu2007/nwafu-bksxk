...
(function(factory) {
	...
	function _onMoveToSelf(fromEl, _dragEl) {
		var sortable = fromEl[expando];
		var fun = sortable.options.onMoveToSelf;
		if (fun) {
			var evt = document.createEvent('Event');
			evt.initEvent('moveToSelf', true, true);
			evt.dragged = _dragEl;
			fun.call(sortable, evt);
		}
	}
